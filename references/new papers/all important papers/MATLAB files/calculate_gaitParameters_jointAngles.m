...
gaitParameters.stepLength.right = abs(data_openpose.scaling.factor*(data_openpose.filt_data(events_openpose.rhs_frames,12,1) - data_openpose.filt_data(events_openpose.rhs_frames,15,1)))';
gaitParameters.stepLength.left = abs(data_openpose.scaling.factor*(data_openpose.filt_data(events_openpose.lhs_frames,15,1) - data_openpose.filt_data(events_openpose.lhs_frames,12,1)))';
